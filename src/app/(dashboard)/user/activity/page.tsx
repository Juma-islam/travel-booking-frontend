...
// Fallback demo activities when no backend data
const DEMO_ACTIVITIES: ActivityItem[] = [
  {
    _id: "a1",
    type: "booking",
    title: "Booking Confirmed",
    message: "Your booking for European Adventure has been confirmed.",
    read: true,
  ...
  },
  {
    ...
    message: "Your 7-day Bali itinerary was generated by the AI Planner.",
    read: true,
  ...
  },
  {
    ...
    message: "Discount code SUMMER25 was applied to your booking.",
    read: true,
  ...
  },
  {
    ...
    message: "Payment of $2,499 received for Bali Paradise package.",
    read: true,
  ...
  },
  {
    ...
    type: "alert",
    title: "Trip Reminder",
    message: "Your trip to Tokyo starts in 7 days. Check your documents!",
    read: true,
  ...
  },
  {
    ...
    message: "Welcome to TravelAI! Your account was created successfully.",
    read: true,
  ...
  const fetchActivities = async (showRefresh = false) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setActivities(data.length > 0 ? data : DEMO_ACTIVITIES);
      } else {
        setActivities(DEMO_ACTIVITIES);
      }
    } catch {
